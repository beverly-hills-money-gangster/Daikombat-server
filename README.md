...
- `GAME_SERVER_PLAYER_STATS_TIMEOUT_MLS` Max time (in milliseconds) to keep disconnected player's stats(kills and deaths). Used for connection recovery. Default - `120000`.
