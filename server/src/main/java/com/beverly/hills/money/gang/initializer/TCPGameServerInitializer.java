...
import com.beverly.hills.money.gang.handler.inbound.tcp.GameServerInboundHandler;
...
public class TCPGameServerInitializer extends ChannelInitializer<SocketChannel> {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(TCPGameServerInitializer.class);
