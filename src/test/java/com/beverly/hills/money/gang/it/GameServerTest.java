...
public class GameServerTest {
    ...
    public class DemoClientHandler extends SimpleChannelInboundHandler<ServerCommand> {
        ...
        @Override
        protected void channelRead0(ChannelHandlerContext ctx, ServerCommand msg) throws Exception {
