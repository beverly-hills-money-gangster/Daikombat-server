package com.beverly.hills.money.gang.init;
...
public class TCPGameConnectionInitializer extends ChannelInitializer<SocketChannel> {
  ...
  private final TCPGameNetworkStats tcpGameNetworkStats;
  ...
  protected void initChannel(SocketChannel ch) {
    ...
    p.addLast(new SimpleChannelInboundHandler<ServerResponse>() {
      ...
      public void channelInactive(ChannelHandlerContext ctx) {
        LOG.info("Channel closed. Network stats {}", tcpGameNetworkStats);
        onDisconnect.run();
      }
